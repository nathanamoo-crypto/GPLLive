...
const styles = StyleSheet.create({
  ...
  stepCircleDone: { backgroundColor: Colors.win },
  stepCircleText: { fontSize: 12, fontWeight: '700', color: Colors.textSecondary },
  stepCircleTextActive: { color: Colors.textInverse },
  ...
  // Setup
  nameInput: { backgroundColor: Colors.surface, padding: 16, borderRadius: 12, borderWidth: 1, borderColor: Colors.border, fontSize: 16 },
  badgePickerRow: { marginBottom: 24 },
  badgePickerItem: { alignItems: 'center', marginRight: 12, padding: 4, borderRadius: 10, borderWidth: 2, borderColor: 'transparent' },
  badgePickerItemActive: { borderColor: Colors.primary },
  badgeCircle: { width: 36, height: 36, borderRadius: 18, backgroundColor: Colors.surfaceAlt, alignItems: 'center', justifyContent: 'center', marginBottom: 4 },
  badgeCircleText: { fontSize: 12, fontWeight: '800', color: Colors.textInverse },
  badgePickerLabel: { fontSize: 10, color: Colors.textSecondary },
  ...
  compoBadgeFull: { backgroundColor: Colors.win },
  compoBadgeEmpty: { opacity: 0.5 },
  compoBadgeLabel: { fontSize: 10, fontWeight: '700', color: Colors.textSecondary },
  compoBadgeCount: { fontSize: 10, fontWeight: '800', color: Colors.textPrimary },
  compoBadgeCountFull: { color: Colors.textInverse },
  compoTotal: { marginLeft: 'auto', backgroundColor: Colors.surfaceAlt, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  compoTotalText: { fontSize: 12, fontWeight: '700', color: Colors.textPrimary },

  posTabRow: { flexDirection: 'row', padding: 12, gap: 8, backgroundColor: Colors.surface, borderBottomWidth: 1, borderBottomColor: Colors.borderLight },
  posTab: { paddingVertical: 6, paddingHorizontal: 14, borderRadius: 16, backgroundColor: Colors.surfaceAlt },
  posTabActive: { backgroundColor: Colors.primary },
  posTabText: { fontSize: 13, fontWeight: '600', color: Colors.textSecondary },
  posTabTextActive: { color: Colors.textInverse },
  ...
  addButtonDisabled: { backgroundColor: Colors.textTertiary, opacity: 0.5 },
  ...
  backButton: { paddingVertical: 14, paddingHorizontal: 24, borderRadius: 16, borderWidth: 1, borderColor: Colors.border },
  backButtonText: { fontSize: 14, fontWeight: '700', color: Colors.textSecondary },
  nextButton: { flex: 1, paddingVertical: 14, borderRadius: 16, backgroundColor: Colors.primary, alignItems: 'center' },
  nextButtonDisabled: { backgroundColor: Colors.border },
  nextButtonText: { color: Colors.textInverse, fontSize: 14, fontWeight: '800' },
  ...
  jerseyChipText: { color: Colors.textInverse, fontSize: 11, fontWeight: '700' },
  ...
  formationChipText: { fontSize: 12, fontWeight: '700', color: Colors.textSecondary },
  formationChipTextActive: { color: Colors.textInverse },
  ...
  playerChipVice: { borderWidth: 2, borderColor: Colors.textTertiary },
  playerChipName: { color: Colors.textInverse, fontSize: 11, fontWeight: '700' },
  roleBadge: {
    width: 18,
    height: 18,
    borderRadius: 9,
  ...
  roleBadgeVice: { backgroundColor: Colors.textTertiary },
  roleBadgeText: { fontSize: 9, fontWeight: '900', color: Colors.textPrimary },
  ...
  benchChipName: { fontSize: 12, fontWeight: '700', color: Colors.textPrimary, flex: 1 },
  benchChipPos: { fontSize: 10, fontWeight: '600', color: Colors.textTertiary },
  confirmButton: { flex: 1, paddingVertical: 14, borderRadius: 16, backgroundColor: Colors.primary, alignItems: 'center' },
  confirmButtonText: { color: Colors.textInverse, fontSize: 14, fontWeight: '800' },
  ...
  lockButtonText: { color: Colors.textInverse, fontSize: 15, fontWeight: '700' },
  lockedPitchContainer: { padding: 16 },
  formationLabel: { fontSize: 14, fontWeight: '700', color: Colors.textSecondary, marginBottom: 8, textAlign: 'center' },
  ...
  viceBadge: { backgroundColor: Colors.textTertiary },
  captainBadgeText: { fontSize: 12, fontWeight: '700', color: Colors.textPrimary },
  benchPitchSection: { marginTop: 16, paddingTop: 12, borderTopWidth: 1, borderTopColor: Colors.border },
  benchLabel: { fontSize: 12, fontWeight: '700', color: Colors.textTertiary, marginBottom: 8 },
  ...
  benchPitchName: { fontSize: 11, color: Colors.textSecondary },
  ...
  hubTabText: { fontSize: 13, fontWeight: '600', color: Colors.textSecondary },
  hubTabTextActive: { color: Colors.textInverse },
  ...
  teamSummaryPoints: { fontSize: 40, fontWeight: '800', color: Colors.fantasyGold },
  teamSummaryLabel: { fontSize: 13, color: Colors.textTertiary, marginTop: 4 },
  teamSummaryRow: { flexDirection: 'row', marginTop: 12, gap: 24 },
  teamSummaryStat: { alignItems: 'center' },
  teamSummaryStatValue: { fontSize: 18, fontWeight: '700', color: Colors.textPrimary },
  teamSummaryStatLabel: { fontSize: 11, color: Colors.textTertiary, marginTop: 2 },
  ...
  leaguesCreateText: { color: Colors.textInverse, fontSize: 13, fontWeight: '700' },
  leagueCard: {
    backgroundColor: Colors.surface,
    borderRadius: 16,
    padding: 16,
  ...
  leagueStatValue: { fontSize: 14, fontWeight: '700', color: Colors.textPrimary },
  leagueStatLabel: { fontSize: 10, color: Colors.textTertiary, marginTop: 2 },
});
