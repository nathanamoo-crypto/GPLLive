...
const tabs: Array<{ key: 'predict' | 'vote'; label: string }> = [
  { key: 'predict', label: 'Predict' },
  { key: 'vote', label: 'Vote' },
];

export default function PredictRoot() {
  const [activeTab, setActiveTab] = useState<'predict' | 'vote'>('predict');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.placeholder}>The {activeTab === 'predict' ? 'prediction' : 'vote'} tab content will display here.</Text>
      </View>
    </View>
  );
}
